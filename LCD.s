...
global  LCD_Setup, LCD_Write_Message, LCD_line2, LCD_line1, LCD_Send_Byte_D, LCD_delay_ms, LCD_delay_x4us
...
LCD_line1:
    	movlw	10000000B	; move to DDRAM address 64
	call	LCD_Send_Byte_I
	movlw	10		; wait 40us
	call	LCD_delay_x4us
	return
...
LCD_line2:
    	movlw	11000000B	; move to DDRAM address 64
	call	LCD_Send_Byte_I
	movlw	10		; wait 40us
	call	LCD_delay_x4us
	return
